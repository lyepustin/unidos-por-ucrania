            ...
            <div className="blog-details-wrapper col-xl-8 col-lg-10 col-12 mx-auto">
              <div className="single-blog-details fix">
                ...
                <div className="blog-details-content fix">
                  <h3 className="blog-title">Randomised Words Which Don't Look Out</h3>
                  ...
                  <p>
                    There are many variaons of passages of Lorem Ipsuable, amrn in some by injected humour, There are
                  ...
                  <blockquote>
                    <p>
                      ...
                      which don't look even slightly believable. If you are going to use a passage of Loremsum, you need
                      to be sure there isn't anything embarrassing hidden in the middle of text.
                    </p>
                  </blockquote>
                  <p>
                    Lorem Ipsuable, amrn in some by injected humour, There are many variations of passages of Lorem
                    Ipsum available, but the majority have suffered alteration in some form, by injected humour, or
                    randised words which don't look even slightly believable. If you are going to use a passage of Lorem
                  ...
                  <div id="page-banner-area" className="page-banner-area section">
                    <div className="page-banner-wrapper text-center col-12">
