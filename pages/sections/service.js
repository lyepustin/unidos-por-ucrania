      ...
      <div className="container">
        ...
        <div className="row">
          ...
          >
            ...
            <h4>{t("pick-up")}</h4>
            <p>
              Existen un total de <b>A</b> puntos de recogida de material
              humanitario.
            </p>
            <p>
              Existen un total de <b>B</b> cuidades con puntos de recogida de
          ...
          >
            ...
            <p>
              Disponemos de <b>C</b> centros de logística, donde se realizan las
              operaciones de almacenaje, procesamiento y empaquetado de ayuda
              material humanitario.
            </p>
          </div>
          ...
          >
            ...
            ></span>
            <h4>{t("humanitarian supplies", { value: 1000 })}</h4>
          ...
          >
            ...
            <p>
              Pretendemos dar a conocer el trabajo y colaboración de las{" "}
              <b>I</b> asociaciones en la ayuda a Ucrania por la invasión rusa.
            </p>
          </div>
          ...
          >
            ...
            <p>
              Agradecemos el apoyo de todos los <b>J</b> colaboradores y
              empresas que hacen posible nuestro trabajo.
            </p>
          </div>
          ...
          >
            ...
            <h4>{t("volunteers")}</h4>
            <p>
              Gracias a la colaboración de nuestros <b>K</b> voluntarios,
              podemos ayudar a Ucrania a resistir la invasión rusa.
            </p>
          </div>
        </div>
      </div>
